 ...
 fonts: {
	...
	footer: {
		...
		content: [
			...
			'<a title="无聊湾 🥱 The Boring Bay" href="https://boringbay.com"><img alt="无聊湾 Badge" height="50px" loading="eager" src="https://boringbay.com/api/badge/blog.245179.xyz"></a>',
			'<img alt="Netlify Status" loading="eager" src="https://api.netlify.com/api/v1/badges/c669c5a6-ac66-4f4d-9813-0edd3ed59146/deploy-status" />',
			"**感谢访问我的网站**",
			...
			'<a style="text-decoration:none;color:#51c4d3;" href="https://travel.moe/go.html" title="异次元之旅-跃迁-我们一起去萌站成员的星球旅行吧！" target="_blank"><img alt="异次元之旅" src="https://travel.moe/images/icon/icon64.png" loading="eager" style="width:24px;height:24px">异次元之旅</a> | <a href="https://www.travellings.cn/go.html" target="_blank" rel="noopener" title="开往-友链接力"><img src="https://www.travellings.cn/assets/logo.gif" alt="开往-友链接力" loading="eager" width="100"></a>',
