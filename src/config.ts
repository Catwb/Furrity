 ...
 fonts: {
	...
	footer: {
		...
		content: [
			...
			'<a title="无聊湾 🥱 The Boring Bay" href="https://boringbay.com"><img height="50px" loading="eager" src="https://boringbay.com/api/badge/blog.245179.xyz"></a>',
			...
			'<a style="text-decoration:none;color:#51c4d3;" href="https://travel.moe/go.html" title="异次元之旅-跃迁-我们一起去萌站成员的星球旅行吧！" target="_blank"><img src="https://travel.moe/images/icon/icon64.png" loading="eager" style="width:24px;height:24px">异次元之旅</a> | <a href="https://www.travellings.cn/go.html" target="_blank" rel="noopener" title="开往-友链接力"><img src="https://www.travellings.cn/assets/logo.gif" alt="开往-友链接力" loading="eager" width="100"></a>',
