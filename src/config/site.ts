...
export const siteConfig: SiteConfig = {
	...
	footer: {
		...
		content: [
			...
			'<a title="无聊湾 🥱 The Boring Bay" href="https://boringbay.com"><img alt="无聊湾 Badge" width="300" height="59" loading="lazy" src="https://boringbay.com/api/badge/blog.furryawa.com"></a>',
			"**感谢访问我的网站**",
			'<div style="font-size: 0.85rem"><span id="timeDate">载入天数...</span> <span id="times">载入时分秒...</span> <script>(function(){if(window.__runtimeLoaded)return;window.__runtimeLoaded=true;var __s=document.createElement("script");__s.src="https://cdn.245179.xyz/js/runtime.js";__s.async=true;document.body.appendChild(__s)})()</script></div>',
	...
	twikoo: {
		...
		region: "",
		lang: "zh-CN",
		cdn: "https://cdnjs.cloudflare.com/ajax/libs/twikoo/1.7.19/twikoo.min.js",
